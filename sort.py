#### ***** source fork from https://github.com/antiboredom/videogrep
...
# 1. POS tag & sort alphabetically
# 2. get prev|next word of the search term
# 3. remix how to do "DT JJ NN VB" without the entire line or sort them into arrays and recomposite

def sorted(inputfile, outputfile, maxclips, minsilence, maxsilence, padding=0, test=False, randomize=False):
...
if __name__ == '__main__':
    ...
    sorted(inputfile=args.inputfile, outputfile=args.outputfile, maxclips=args.maxclips, minsilence=args.minsilence, maxsilence=args.maxsilence, padding=args.padding, test=args.test, randomize=args.randomize)
